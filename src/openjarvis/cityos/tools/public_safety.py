...
class PublicSafetyTool(CityOSTool):
    ...
    description = "Submit a non-emergency incident report (traffic, sanitation, infrastructure). For emergencies, call 911."
    parameters = {
        "type": "object",
        "properties": {
            "incident_type": {
                "type": "string",
                "enum": ["traffic", "sanitation", "infrastructure", "lighting", "other"],
            },
    ...
    def run(self, params: dict[str, Any], tenant_id: str | None = None) -> dict[str, Any]:
        ...
        return {
            ...
            "status": "received",
            "message": "Your report has been received and will be reviewed within 24 hours.",
        }
