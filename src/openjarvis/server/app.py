...
def create_app(
    ...
    *,
    ...
    # CityOS voice service router
    try:
        from openjarvis.cityos.voice_service import router as voice_router

        app.include_router(voice_router)
        logger.info("CityOS voice service router mounted at /v1/voice")
    except Exception as exc:
        logger.debug("CityOS voice service router init skipped: %s", exc)
